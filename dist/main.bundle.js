...
var GraficosComponent = /** @class */ (function () {
    ...
    GraficosComponent.prototype.obtReporte = function () {
        ...
        for (var i = 0; i < 2; i++) {
            if (!this.waiter) {
                setTimeout(function () { console.log('Archivo descargando'); }, 1000);
