...
La version 2 (v2) del programa, obtiene los primeros 200 valores de los 20 buses que se encuentren en el archivo, esto permite una mejor visualización de datos que la version anterior, pero igual no es la mejor.